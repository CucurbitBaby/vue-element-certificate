<template>
  <div class="certificate-drag-ctrl">
    ...
    <div type="primary" class="switch-btn-fixed drawer-handle" @click="handleClickTest">
    ...
    >
      <div class="toolbar-help" style="position: relative;">
        ...
        <div style="position: absolute; right: 0; top: 20px;">
          ...
          <el-link type="primary" :underline="false" style="margin-left: 5px;">{{ direction ? '横屏' : '竖屏' }}</el-link>
        </div>
      </div>
      ...
      <div class="panel-controls">
        ...
        <div style="display: flex; margin-top: 12px;">
          <input ref="iptRef" accept="image/*" style="display: none" type="file" @change="handleChangeBgImg">
          <el-button style="flex: 1" type="primary" plain @click="handleClickChangeBg">更换背景图片</el-button>
        </div>
        ...
        <el-row class="certificate-drag-ctrl__row">
          <div><el-button type="primary" plain icon="el-icon-edit" @click="handleClickAddBtn">添加文字</el-button></div>
          <div><el-button type="primary" plain icon="el-icon-picture-outline" @click="handleClickAddBtn">添加图片</el-button></div>
        </el-row>
        ...
        <div type="primary" class="switch-btn drawer-handle" @click="handleClickTest">
